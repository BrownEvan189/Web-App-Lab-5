...
<html>
	...
	<?php 
...

			{
				...
				$sql1="SELECT * FROM registration_tab WHERE fid='".$row['fid']."'";
				...
				<table border="1">
					...
					<?php
						...
						while($row1 = $result1->fetch_assoc()){
							...
							$sql3="SELECT * FROM registration_tab WHERE cid='".$row1['cid']."'";
							$result3 = $connect->query($sql3);
							
							while($row3 = $result3->fetch_assoc()){
								$sql4="SELECT * FROM student_tab WHERE stuid='".$row3['stuid']."'";
								$result4=$connect->query($sql4);
								$row4 = $result4->fetch_assoc();
								
								echo "</tr><tr><td></td><td></td><td></td><td></td><td>".$row4['name']."</td>";
							}
							echo "</tr>";
						}
					?>
